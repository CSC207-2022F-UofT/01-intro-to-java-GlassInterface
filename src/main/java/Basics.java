...
public class Basics {
    ...
    public static String split(String to_split) {
        ...
        // Define a variable to keep the array for the split string
        String[] splitted_str = to_split.split(" ");

        // Loop to add the first character of each array item to ret
    ...
    public static int oddSum(int[] arr) {
         ...
         */
        // Iterate from 1 onward to the length of the array, going to odd indices while indices are valid
        for (int i = 1; i <= arr.length - 1; i = i + 2) {

            // Add integers at odd indices to current_sum
